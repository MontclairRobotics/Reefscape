...
public class AlignToReefTagCommand2 extends Command {
    ...
    public AlignToReefTagCommand2(int tagId, TagOffset direction, Limelight camera) {
        this.tagId = tagId;
    ...
    public void execute() {
        ...
        //     thetaSpeed = thetaController.calculate(Units.degreesToRadians(tx));
        // } else {
        //     thetaController.setSetpoint(tagRotation);
        //     thetaSpeed = thetaController.calculate(theta);
        // }
        thetaController.setSetpoint(tagRotation);
        thetaSpeed = thetaController.calculate(theta);
