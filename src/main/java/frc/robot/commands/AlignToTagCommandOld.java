...
//      */
//     public AlignToTagCommand2(TagOffset offset, boolean isOffset, boolean useTagSize) {
...
//      * @param useTagSize If true, uses the size of the tag to determine distance, otherwise uses the height of the tag
//      */
//     public AlignToTagCommand2(int tagId, TagOffset offset, boolean isOffset, boolean useTagSize) {
...
//      * @param useTagSize If true, uses the size of the tag to determine distance, otherwise uses the height of the tag
//      */
//     public AlignToTagCommand2(String autoCoralPosition, boolean isOffset, boolean useTagSize) {
...
//                 tagId = Auto.blueCoralToTagMap.get(autoCoralPosition);
//             } else {
//                 tagId = Auto.redCoralToTagMap.get(autoCoralPosition);
//             }
//         } else {
//             tagId = camera.getLargestAprilTag(Limelight.tagRotationsMap.keySet());
//         }
//         System.out.println("************** AlignToTagCommand tagId: " + tagId);
//         if (tagId == -1) {
